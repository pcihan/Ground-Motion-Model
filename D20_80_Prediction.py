...
Original file is located at
    https://colab.research.google.com/drive/1nP7qlGbj3A2VYdfpmUqK56NX2swrIEOB
"""
...
plt.grid(True)
plt.tight_layout()
plt.savefig("CAV XGBoost.p
plt.savefig("d20_80 XGBoost.png", dpi=300)
plt.show()
...
plt.grid(True)
plt.tight_layout()
plt.savefig("d20_80 RandomForest.png", dpi=300)
plt.show()
...
plt.grid(True)
plt.tight_layout()
plt.savefig("d20_80 LinearRegression.png", dpi=300)
plt.show()
...
plt.grid(True)
plt.tight_layout()
plt.savefig("d20_80 GBR.png", dpi=300)
plt.show()
...
plt.grid(True)
plt.tight_layout()
plt.savefig("d20_80 stacking_LR.png", dpi=300)
plt.show()
...
plt.grid(True)
plt.tight_layout()
plt.savefig("d20_80 Stacking-GBR.png", dpi=300)  # Görseli kaydet
plt.show()
...
shap.summary_plot(combined_shap_values, combined_X_test, feature_names=X.columns)
plt.savefig("d20_80 SHAP.png", dpi=300)
shap.summary_plot(combined_shap_values, combined_X_test, plot_type="bar", feature_names=X.columns)