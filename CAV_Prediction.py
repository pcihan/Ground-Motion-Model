...
Original file is located at
    https://colab.research.google.com/drive/1mWHnFbwrfh4jubM5AtwAegkUab1X2TI4
"""
...
plt.grid(True)
plt.tight_layout()
plt.savefig("CAV XGBoost.png", dpi=300)
plt.show()
...
plt.grid(True)
plt.tight_layout()
plt.savefig("CAV RandomForest.png", dpi=300)
plt.show()
...
plt.grid(True)
plt.tight_layout()
plt.savefig("CAV LinearRegression.png", dpi=300)
plt.show()
...
plt.grid(True)
plt.tight_layout()
plt.savefig("CAV GBR.png", dpi=300)
plt.show()
...
plt.grid(True)
plt.tight_layout()
plt.savefig("CAV stacking_LR.png", dpi=300)
plt.show()
...
plt.grid(True)
plt.tight_layout()
plt.savefig("CAV Stacking-GBR.png", dpi=300)  # Görseli kaydet
plt.show()
...
plt.savefig("CAV-SHAP.png", dpi=300)