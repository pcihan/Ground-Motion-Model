...
Original file is located at
    https://colab.research.google.com/drive/1LXHORD9ZPU25cIks4IdKJ8ilDGXN1_xx
"""
...
plt.grid(True)
plt.tight_layout()
plt.savefig("d5_75 XGBoost.png", dpi=300)
plt.show()
...
plt.grid(True)
plt.tight_layout()
plt.savefig("d5_75 RandomForest.png", dpi=300)
plt.show()
...
plt.grid(True)
plt.tight_layout()
plt.savefig("d5_75 LinearRegression.png", dpi=300)
plt.show()
...
plt.grid(True)
plt.tight_layout()
plt.savefig("d5_75 GBR.png", dpi=300)
plt.show()
...
plt.grid(True)
plt.tight_layout()
plt.savefig("stacking_LR.png", dpi=300)
plt.show()
...
from scipy.stats import pearsonr  # Pearson korelasyon için
import matplotlib.pyplot as plt  # Scatter plot için
...
plt.grid(True)
plt.tight_layout()
plt.savefig("d5_75 Stacking-GBR.png", dpi=300)  # Görseli kaydet
plt.show()
...
plt.savefig("d5_75 SHAP.png", dpi=300)
