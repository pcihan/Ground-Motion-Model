...
Original file is located at
    https://colab.research.google.com/drive/1glx2UN0zWvaMayad8ylz3z9mR5PCYSxd
"""
...
plt.grid(True)
plt.tight_layout()
plt.savefig("d5_95 XGBoost.png", dpi=300)
plt.show()
...
plt.grid(True)
plt.tight_layout()
plt.savefig("d5_95 RandomForest.png", dpi=300)
plt.show()
...
plt.grid(True)
plt.tight_layout()
plt.savefig("d5_95 LinearRegression.png", dpi=300)
plt.show()
...
plt.grid(True)
plt.tight_layout()
plt.savefig("d5_95 GBR.png", dpi=300)
plt.show()
...
plt.grid(True)
plt.tight_layout()
plt.savefig("d5_95 stacking_LR.png", dpi=300)
plt.show()
...
plt.grid(True)
plt.tight_layout()
plt.savefig("d5_95 Stacking-GBR.png", dpi=300)  # Görseli kaydet
plt.show()
...
plt.savefig("d5_95 SHAP.png", dpi=300)
